...
<div>
    ...
    <form class="layui-form" action="${request.contextPath}/permission/add" id="permission_add_form">

        <div class="layui-form-item">
            <label class="layui-form-label">任务名称</label>
            <div class="layui-input-block">
                <input type="text" name="permissionName" required  lay-verify="required" placeholder="请输入任务名称" autocomplete="off" class="layui-input" >
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input  name="permissionGroup" required lay-verify="required" placeholder="请输入任务分组" autocomplete="off" class="layui-input" >
            </div>
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <a class="layui-btn"  onclick="topermissionAdd('${request.contextPath}/permission/queryList')">立即提交</a>
...
<script src="${request.contextPath}/js/permission/permission_add.js"></script>
